...
import { NewsletterFeatureComponent } from 'projects/qer/src/lib/support/newsletter-feature/newsletter-feature.component';
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  public openDialog() {
    ...
    this.dialog.open(NewsletterFeatureComponent, dialogConfig);
  }
}
